...
export const welcome = () => {
  const line = '═══════════════════════════════════════════════════════════════════════════ \n';
  const coolGradient = gradient(['#58167D', '#336535', '#B20053', '#850F5B']);
  ...
  CFonts.say('md-links', {
    ...
    gradient: ['#58167D', '#336535', '#B20053', '#850F5B'], // define your gradient colors
  ...
  CFonts.say('  tool checker', {
    ...
    maxLength: '0',
    length: '2',
    gradient: ['#58167D', '#336535', '#B20053', '#850F5B'],
...
export const statsValidate = (links) => {
  const data = [
    ...
    [`${chalk.hex('#A41421').bold('Broken Links')}`, `${brokenLinks(links)}`],
  ];
...
export const tableLinks = (links) => {
  ...
  const test = links.map((link) => [link.text.slice(0, 51), link.href, link.file]);
